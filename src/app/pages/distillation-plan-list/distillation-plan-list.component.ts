...
export class DistillationPlanListComponent implements OnInit {
  ...
  public deleteDistillationPlan(distillationPlan: DistillationPlan) {
  ...
  public navigateToUpdateDistillationPlan(distillationPlan: DistillationPlan) {
    let navigationExtras: NavigationExtras;
    navigationExtras = {
      queryParams: {
        'distillationPlan': JSON.stringify(distillationPlan),
      },
    };
  ...
  openDeleteDialog(distillationPlan: DistillationPlan) {
    this.dialogService.open(DialogNamePromptComponent)
      .onClose.subscribe(name => this.deleteDistillationPlan(distillationPlan));
  }
